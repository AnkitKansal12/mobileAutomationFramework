...
public class SendEmailUtil extends BasePage {
	...
	public void sendEmail() {
		...
		Session session = Session.getDefaultInstance(props,
				...
				new javax.mail.Authenticator() {
					...
					protected PasswordAuthentication getPasswordAuthentication() {
						...
						return new PasswordAuthentication("ankit.kansa32@gmail.com", "Ankita1234");
		...
		try {
			...
			message.setFrom(new InternetAddress("ankit.kansa32@gmail.com"));

			// Set the recipient address
			message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("ankit.1.kansal@niit-tech.com"));
			...
			// set the file
			messageBodyPart2.setFileName(Reports);
